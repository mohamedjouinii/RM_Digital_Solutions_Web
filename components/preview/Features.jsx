        ...
        <div className="row g-5 mt--5">
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
            <div className="service service__style--1 bg-color-blackest radius text-center rbt-border h-100">
              ...
              <div className="content">
                ...
                <p className="description b1 color-gray mb--0">
                  Our Template is full Perfect for all device.It is made by
                  Nextjs Structure.
                </p>
              </div>
            </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
            <div className="service service__style--1 bg-color-blackest radius text-center rbt-border h-100">
              ...
              <div className="content">
                ...
                <p className="description b1 color-gray mb--0">
                  The tamplate has SASS available for css. You can change css by
                  SASS
                </p>
              </div>
            </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
            <div className="service service__style--1 bg-color-blackest radius text-center rbt-border h-100">
              ...
              <div className="content">
                <h4 className="title w-600">
                  <a href="#">Bootstrap v5 Comfortable</a>
                </h4>
                <p className="description b1 color-gray mb--0">
                  Bootstrap v5 comfortable is available in Doob. So layout
