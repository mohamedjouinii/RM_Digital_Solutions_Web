...
export default function Portfolio() {
  ...
  return (
    <div className="rainbow-portfolio-area rainbow-section-gapBottom">
          ...
          <div className="col-lg-12">
            ...
            >
              <h4 className="subtitle">
                <span className="theme-gradient">Project</span>
              </h4>
              <h2 className="title w-600 mb--20">Check My Recent Works!</h2>
          ...
          <div className="col-lg-12">
            ...
            >
              ...
              {portfolios.map((portfolio) => (
                <div
                  key={portfolio.id}
                  className={`portfolio-3 ${portfolio.categories}`}
                >
